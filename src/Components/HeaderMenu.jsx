...
function HeaderMenu({ toggleVisibility, scrollToSection, checkActive}) {
  ...
  return (
    <div className="flex flex-col gap-y-5 animate-slide-in bg-white w-[100dvw] h-[100dvh] z-200 fixed top-0 bottom-0 right-0 left-0 p-5 pt-[100px]">
      <div
      ...
      >
        Home
        {checkActive('home')?<i className="fa-solid fa-circle-chevron-left text-xl text-red"></i>:''}
      </div>
      <div
